 ...
 *                `User` 객체 - 해당 user객체의 waitMatching(매칭 대기중인 subject)과 deadline(목표기간)을 null값으로 변경 <br>
 *                (ex. waitMatching값이 ft_printf이고 deadline이 '3일'인 경우 둘 다 null로 변경해 매칭 대기 취소)<br><br>
